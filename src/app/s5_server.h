...
#define S5_TIMEOUT	 8
#define S5_AUTH_MAGIC     0xa001beef
#define S5_METAN    8192
...
typedef struct {
    ...
    char  key[16];
    char  secret[16];
} __attribute__((packed)) s5_auth_t;
...
} __attribute__((packed)) s5_rfc_phase1_resp_t ;
...
} __attribute__((packed)) s5_rfc_phase2_resp_t ;
